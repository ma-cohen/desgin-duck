...
// src/domain/requirements/requirement.ts
var PRIORITIES = ["high", "medium", "low"];
var STATUSES = ["draft", "review", "approved"];
var DERIVED_CATEGORIES = [
  "technical",
  "operational",
  "quality",
  "constraint"
...
function validateMainRequirement(raw) {
...
function validateDerivedRequirement(raw) {
  if (raw === null || typeof raw !== "object") {
    return { valid: false, errors: ["Requirement must be an object"] };
  }
  const o = raw;
...
function readDerivedRequirements(requirementsDir) {
  const filePath = join2(requirementsDir, "derived.yaml");
  if (process.env.DEBUG) {
